...
export const ChatItem = ({
  ...
  return (
    <div className="group relative flex w-full items-center p-4 transition hover:bg-black/5">
                      ...
                      <FormControl>
                        <div className="relative w-full">
                          <Input
                            ...
                            autoSave="off"
                            autoComplete="off"
                            className="focus-visible:rign-0 border-0 border-none bg-zinc-200/90 p-2 text-zinc-600
      ...
      {canDeleteMessage && (
        <div
          className="absolute -top-2 right-5 hidden items-center gap-x-2 rounded-sm border bg-white
