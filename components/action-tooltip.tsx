    ...
    <Tooltip.Provider skipDelayDuration={0}>
      <Tooltip.Root delayDuration={50}>
        ...
        <Tooltip.Portal>
          <Tooltip.Content
            side={side}
            className="dark:text-blackA z-50 select-none rounded-[4px] bg-white px-3 py-3 text-[15px]
              font-semibold leading-none shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]
              ...
              dark:bg-black dark:shadow-zinc-800"
            sideOffset={5}
          >
            {label}
